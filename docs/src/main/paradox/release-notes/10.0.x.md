 ...
 * Remove unnecessary implicit `materializer` parameter in several top-level @scala[@apidoc[Http$]]@java[@javadoc[Http](akka.http.javadsl.Http)] entry point APIs ([#1464](https://github.com/akka/akka-http/issues/1464))
